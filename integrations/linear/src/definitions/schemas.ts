...
export const issueEventSchema = z.object({
  ...
  userId: z
    ...
    .optional()
    .describe(
      'The Mlagent User ID of the individual who initiated the issue. If not provided, it indicates the issue was generated by the bot.'
    ),
  conversationId: z.string().describe('Mlagent Conversation ID of the issue'),
})
