import { z, IntegrationDefinition, interfaces } from '@mlagent/sdk'
...
export default new IntegrationDefinition({
  ...
  version: '0.4.1',
  description:
    "Elevate your chatbot's capabilities with the Mlagent integration for Google Calendar. Seamlessly sync your chatbot with Google Calendar to effortlessly manage events, appointments, and schedules",
