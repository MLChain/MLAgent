...
Once these steps are completed, your Zendesk articles will automatically sync to the specified knowledge base in Mlagent. You can manually sync by using the "Sync KB" action.
