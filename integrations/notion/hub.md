...
The Notion Integration for Mlagent Studio allows you to do the following things:
...
Give your integration access to all the pages and databases that you want to use with Mlagent

### Step 3 - Configure your Bot

Give your integration access to all the pages and databases that you want to use with Mlagent. [Share a database with your integration - Notion Developers](https://developers.notion.com/docs/create-a-notion-integration#step-2-share-a-database-with-your-integration)

You need a token to get your newly created Notion Integration _(not the same as Mlagent Studio's Notion Integration)_ connected with Mlagent Studio:
