...
export const syncMembers = {
  title: 'Sync Members',
  description:
    'Sync Slack workspace members to Mlagent users. This action keeps track of the last sync timestamp and will only sync updated members since the last sync.',
  input: {
    schema: z.object({}),
  },
  output: {
