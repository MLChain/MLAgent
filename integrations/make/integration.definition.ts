import { z, IntegrationDefinition } from '@mlagent/sdk'
...
export default new IntegrationDefinition({
  ...
  icon: 'icon.svg',
  description:
    'Seamlessly connect your Mlagent chatbot with Make.com to unlock a world of possibilities. Automate tasks, sync data across multiple applications, and enhance the capabilities of your chatbot like never before',
  readme: 'hub.md',
  configuration: {
    schema: z
      .object({
