...
const getUserData = {
  title: 'Get User Data',
  description:
    "Get the user's information that was provided when the webchat is initialized with the property \"userData\", for example: window.mlagentWebChat.init({ userData: { name: 'John Doe' } })",
  input: {
    schema: z.object({
