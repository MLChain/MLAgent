...
export default {
  login: { description: 'Login to Mlagent Cloud', schema: config.schemas.login },
  logout: { description: 'Logout of Mlagent Cloud', schema: config.schemas.logout },
  bots: {
  ...
  bundle: { description: 'Bundle a mlagent project', schema: config.schemas.bundle },
  build: { description: 'Generate typings and bundle a mlagent project', schema: config.schemas.build },
