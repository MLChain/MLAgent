import type { Bot as BotImpl, Integration as IntegrationImpl } from '@mlagent/sdk'
...
export class ServeCommand extends ProjectCommand<ServeCommandDefinition> {
  public async run(): Promise<void> {
    ...
    if (projectDef.type === 'interface') {
      throw new errors.MlagentCLIError('An interface project has no implementation to serve.')
    }
