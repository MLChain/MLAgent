...
const apiUrl = {
  type: 'string',
  description: 'The URL of the Mlagent server',
} satisfies CommandOption
...
const globalSchema = {
  ...
  mlagentHome: {
    type: 'string',
    description: 'The path to the Mlagent home directory',
    default: consts.defaultMlagentHome,
  },
...
const loginSchema = {
  ...
  token,
  workspaceId,
  apiUrl: { ...apiUrl, default: consts.defaultMlagentApiUrl },
} satisfies CommandSchema
